namespace NewtonDisplay
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Size = new System.Drawing.Size(648, 94);
            this.label1.TabIndex = 1;
            this.label1.Text = "Найти приближения к периодическим орбитам функции Ньютона для функции\r\nf(z)=z^3+(" + "A-1)z-A, для значений параметра A=0.310+1.620i; (период 2) A=0.275+1.650i (перио" + "д 4)\r\n";
            // 
            // Form1
            // 
